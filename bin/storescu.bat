...
set MAIN_JAR=dcm4che-tool-storescu-5.24.0.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-core-5.24.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-5.24.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-5.24.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-5.24.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-opencv-5.24.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-rle-5.24.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-common-5.24.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\weasis-core-img-4.5.3.jar
