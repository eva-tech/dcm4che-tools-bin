...
set MAIN_JAR=dcm4che-tool-syslogd-5.24.0.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-audit-5.24.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-5.24.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-audit-5.24.0.jar
